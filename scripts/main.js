...
var pixelblock = (function(){
  ...
  var blacklist = [{name:'HubSpot Sales',  pattern:'t.signaux',               url:'http://getsidekick.com'},
                   {name:'HubSpot Sales',  pattern:'t.senal',                 url:'http://getsidekick.com'},
                   {name:'HubSpot Sales',  pattern:'t.sidekickopen',          url:'http://getsidekick.com'},
                   {name:'HubSpot Sales',  pattern:'t.sigopn',                url:'http://getsidekick.com'},
